...
//
// src/rpc/clients/NeoServerRpcClient.ts:59:5 - (ae-forgotten-export) The symbol "BlockJson" needs to be exported by the entry point index.d.ts
// src/rpc/clients/NeoServerRpcClient.ts:98:5 - (ae-forgotten-export) The symbol "BlockHeaderJson" needs to be exported by the entry point index.d.ts
// src/rpc/clients/NeoServerRpcClient.ts:230:5 - (ae-forgotten-export) The symbol "Validator" needs to be exported by the entry point index.d.ts
