## API Report File for "@epicchain/epicvault-core"
...
// Warning: (ae-forgotten-export) The symbol "EpicVaultObject" needs to be exported by the entry point index.d.ts
//
// @public
class Account implements EpicVaultObject<AccountJSON> {
    // (undocumented)
...
// @public
class ContractParam implements EpicVaultObject<ContractParamLike> {
    // (undocumented)
    get [Symbol.toStringTag](): string;
...
class EpicChainContract extends Xep17Contract {
    ...
    // (undocumented)
    static get INSTANCE(): EpicChainContract;
    // (undocumented)
    registerCandidate(publicKey: string | HexString): ContractCall;
    // (undocumented)
    unclaimedEpicChain(address: string, end: number | BigInteger): ContractCall;
    // (undocumented)
    vote(address: string, voteTo: string | HexString): ContractCall;
}

// @public (undocumented)
interface EpicVaultSerializable {
    // (undocumented)
    serialize: () => string;
    // (undocumented)
    size: number;
...
// @public
class Network implements EpicVaultObject<NetworkLike> {
...
// @public
class Protocol implements EpicVaultObject<ProtocolLike> {
    // (undocumented)
    get [Symbol.toStringTag](): string;
...
// @public (undocumented)
function serializeArrayOf(prop: (EpicVaultSerializable | string)[]): string;
...
// @public (undocumented)
class Transaction implements EpicVaultObject<TransactionLike> {
    // (undocumented)
    get [Symbol.toStringTag](): string;
...
// @public (undocumented)
abstract class TransactionAttribute implements EpicVaultSerializable {
    // (undocumented)
...
// @public
class Witness implements EpicVaultObject<WitnessLike> {
...
// @public (undocumented)
abstract class WitnessCondition implements EpicVaultSerializable {
    // (undocumented)
...
// @public (undocumented)
class WitnessRule implements EpicVaultSerializable {
...
// Warning: (ae-forgotten-export) The symbol "EpicVaultLike" needs to be exported by the entry point index.d.ts
//
// @public (undocumented)
type WitnessRuleLike = EpicVaultLike<WitnessRule, WitnessRuleJson>;
