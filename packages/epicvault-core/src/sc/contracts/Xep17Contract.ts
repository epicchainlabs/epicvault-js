 ...
 */
export class Xep17Contract extends BaseContract {
  /**
  ...
  constructor(
    ...
    super(scriptHash, Xep17Contract.getMethods().concat(additionalMethods));
  }
   ...
   *
   * @example
   * const contract = new Xep17Contract(contractHash);
