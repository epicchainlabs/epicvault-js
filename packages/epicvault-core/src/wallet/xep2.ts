...
/**
 * XEP2 - Private Key Encryption based on AES.
...
async function createNep2Key(
  ...
  const assembled =
    XEP2_HEADER + XEP2_FLAG + addressHash + encrypted.ciphertext.toString();
 ...
 * @param scryptParams - optional parameters for Scrypt. Defaults to XEP2 specified parameters.
 ...
 * @param scryptParams - parameters for Scrypt. Defaults to XEP2 specified parameters.
