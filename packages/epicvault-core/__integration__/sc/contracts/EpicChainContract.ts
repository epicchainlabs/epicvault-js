...
describe("EpicChainContract", () => {
  test("getCandidates", async () => {
    const call = EpicChainContract.INSTANCE.getCandidates();
  ...
  test("getRegisterPrice", async () => {
    const call = EpicChainContract.INSTANCE.getRegisterPrice();
    const response = await rpcClient.invokeFunction(
      call.scriptHash,
      call.operation,
      call.args
  ...
  test("registerCandidate", async () => {
    const call = EpicChainContract.INSTANCE.registerCandidate(
  ...
  test("vote", async () => {
    const call = EpicChainContract.INSTANCE.vote(
