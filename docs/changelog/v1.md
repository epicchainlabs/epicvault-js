...
- Ledger support
  ...
  - Add ability to sign using external function for epicvaultDB API.
  - Bugfix for \_emitNum
...
- Address validation to guard against sending to non-EpicChain addresses.
...
- Upgrade API support to v2 for epicvault-wallet-db
